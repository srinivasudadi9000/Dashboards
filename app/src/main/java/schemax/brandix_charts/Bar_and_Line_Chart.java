...
public class Bar_and_Line_Chart extends Activity {
CombinedChart combined_chart;
    protected String[] mMonths = new String[] {
            "Jan", "Feb", "Mar", "Apr", "May", "June","sdfasd"
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bar_and__line__chart);
        combined_chart = (CombinedChart) findViewById(R.id.combined_chart);
        combined_chart.getDescription().setText("This is testing Description");
        combined_chart.setDragEnabled(true);
        combined_chart.setClickable(true);
        combined_chart.setDrawGridBackground(true);
        combined_chart.setDrawBarShadow(true);
        combined_chart.setHighlightFullBarEnabled(true);

        // draw bars behind lines
        combined_chart.setDrawOrder(new CombinedChart.DrawOrder[]{
                CombinedChart.DrawOrder.BAR,  CombinedChart.DrawOrder.LINE
        });
        Legend l = combined_chart.getLegend();
